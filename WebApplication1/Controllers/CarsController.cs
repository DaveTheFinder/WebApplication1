...
namespace WebApplication1.Controllers
{
    public class CarsController : Controller
    {
        ...
        public ActionResult CarsFor(int personId)
        {
            var cars = db.Cars.Where(c => c.PersonId == personId);
            return View(cars.ToList());
        }
        ...
        public ActionResult Create([Bind(Include = "Id,ModelName,Make,Year,PersonId")] Car car)
        {
            if (ModelState.IsValid)
            {
                ...
                MailSender.Send("A new car has been created for you!", 
                    $"<h2>{owner.Name}, A new Car has been created for you!</h2>",
                    new System.Net.Mail.MailAddress(owner.Email));
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,ModelName,Make,Year,PersonId")] Car car)
        {
            if (ModelState.IsValid)
            {
